...
from dagster import MetadataValue, Output, asset, materialize


@asset(group_name='hello')
...
#     asset_value = materialize([hackernews_top_story_ids, hackernews_top_stories])
#     print(asset_value.output_for_node('hackernews_top_stories'))
